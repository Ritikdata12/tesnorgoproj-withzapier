      ...
      <div className="hero-section">
        <div className="job-search">
          <div className="job-search-content">
            <h1 className='hh'>Simplify Credentials<br /> <span className='hh'>Find your invoices</span></h1>
            <p className="hero-desc">
            Welcome to our platform  here you see all the invoices of this due status as well
            as their paid status with their names,emails, items and their puchase date.
            </p>
